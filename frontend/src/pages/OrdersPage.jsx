        ...
        <div className="text-left">
            ...
            <p className="mb-8 text-sm text-base-content/70">
                {staff
                    ...
                    : "Paid orders include customer support: open an order fro chat."}
            </p>
            ...
            {orders.length === 0 ? (
                ...
                <ul className="space-y-4">
                    {orders.map((o) => {
                        ...
                        const summary = lineCount === 0 ? "No line items" : lineCount === 1 ? `${totalUnits} ${totalUnits === 1 ? "item" : "items"}` : `${lineCount} products · ${totalUnits} items`;
